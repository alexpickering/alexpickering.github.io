...
const getFieldsNames = function getFieldsNames(fields) {
  ...
  fields.forEach((f, index) => {
    if (f.has('fields')) {
      ...
      const fields = (_f$get2 = f.get('fields')) === null || _f$get2 === void 0 ? void 0 : _f$get2.toArray();
...
const selectField = (collection, key) => {
  ...
  while ((name = array.shift()) && fields) {
    ...
    if ((_field3 = field) === null || _field3 === void 0 ? void 0 : _field3.has('field')) {
      var _field4;
