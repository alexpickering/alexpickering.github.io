...
const traverseFields = (folderKey, config, collection, entryMap, field, fields, currentFolder) => {
  ...
  for (let f of fields) {
    ...
    if (f.has('fields')) {
      return traverseFields(folderKey, config, collection, entryMap, field, f.get('fields').toArray(), folder);
    } else if (f.has('field')) {
      return traverseFields(folderKey, config, collection, entryMap, field, [f.get('field')], folder);
    }
  }
